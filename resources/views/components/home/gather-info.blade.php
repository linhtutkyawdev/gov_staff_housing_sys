    ...
    <div class="space-y-12">
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="nric" class="block text-sm font-medium leading-6 text-gray-900">NRIC</label>
                    <div class="mt-2">
                        <input type="text" name="nric" id="nric" autocomplete="nric"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="number" name="age" id="age" autocomplete="age" min="18"
                            max="60"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    <label for="exp" class="block text-sm font-medium leading-6 text-gray-900">Exp</label>
                    <div class="mt-2">
                        <input type="number" name="exp" id="exp" autocomplete="exp" min="1"
                            max="45"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    <label for="rank" class="block text-sm font-medium leading-6 text-gray-900">လက်ရှိ ရာထူး</label>
                    <div class="mt-2 bg-green-400">
                        <select id="rank" name="rank" autocomplete="rank"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            <option>ကြီးရေး/ငယ်ရေး</option>
                            <option>ရုံးအုပ်/ဒု-ဦးစီးမှblah</option>
                            <option>...</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    <label for="family-size" class="block text-sm font-medium leading-6 text-gray-900">Family
                        Size</label>
                    <div class="mt-2">
                        <input type="number" name="family-size" id="family-size" autocomplete="family-size"
                            min="1" max="200"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
